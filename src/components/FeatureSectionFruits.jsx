// const data = [
//   { id: 0, img: "windo.png", name: "Dried Mango", price: "$500"},
//   { id: 1, img: "windo.png", name: "Dried Mango", price: "$500"},
//   { id: 2, img: "windo.png", name: "Dried Mango", price: "$500"},
//   { id: 3, img: "windo.png", name: "Dried Mango", price: "$500"},
// ]; 
  ...
  return (
      <div className='container pt-16'>
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 pt-8 gap-2">
          <div>
            <img className="w-full h-full object-cover" src="/windo.png" alt="window" />
          </div>
